...
#include "DungeonGeneratorInteractiveTool.generated.h"


/**
 * Builder for UDungeonGeneratorInteractiveTool
 */
UCLASS()
class DUNGEONGENERATOR_API UDungeonGeneratorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UDungeonGeneratorInteractiveTool
 */
UCLASS(Transient)
class DUNGEONGENERATOR_API UDungeonGeneratorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UDungeonGeneratorInteractiveToolProperties();
...
/**
 * UDungeonGeneratorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class DUNGEONGENERATOR_API UDungeonGeneratorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UDungeonGeneratorInteractiveToolProperties> Properties;

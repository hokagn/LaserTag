...
#include "DungeonGeneratorInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UDungeonGeneratorInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UDungeonGeneratorInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UDungeonGeneratorInteractiveTool* NewTool = NewObject<UDungeonGeneratorInteractiveTool>(SceneState.ToolManager);
...
UDungeonGeneratorInteractiveToolProperties::UDungeonGeneratorInteractiveToolProperties()
{
...
void UDungeonGeneratorInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UDungeonGeneratorInteractiveTool::Setup()
{
	...
	Properties = NewObject<UDungeonGeneratorInteractiveToolProperties>(this, "Measurement");
...
void UDungeonGeneratorInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UDungeonGeneratorInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UDungeonGeneratorInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UDungeonGeneratorInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UDungeonGeneratorInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UDungeonGeneratorInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UDungeonGeneratorInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UDungeonGeneratorInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UDungeonGeneratorInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{

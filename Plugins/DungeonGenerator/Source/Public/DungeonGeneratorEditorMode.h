...
#include "DungeonGeneratorEditorMode.generated.h"
 ...
 */
UCLASS()
class UDungeonGeneratorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_DungeonGeneratorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UDungeonGeneratorEditorMode();
	virtual ~UDungeonGeneratorEditorMode();
